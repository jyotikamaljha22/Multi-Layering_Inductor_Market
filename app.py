...
st.markdown(
    ...
    .stTextInput input {{
        ...
        padding: 12px 14px !important; background-color: #ffffff !important; 
...
# ----------------------------
html_logo = f'<img src="data:image/svg+xml;base64,{LOGO_B64}" style="height:36px; width:auto; filter: brightness(0) invert(1);" />' if LOGO_B64 else ""
...
<head>
    ...
    <style>
        ...
        .header-block { margin-bottom: 2.5rem; padding: 1.5rem 0; border-bottom: 1px solid #e2e8f0; }
        .header-kicker { color: #C49A23; font-size: 0.75rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.25em; margin-bottom: 0.75rem; display: block; }
        .header-main-title { font-size: 2.8rem; font-weight: 800; color: #0f172a; line-height: 1.1; letter-spacing: -0.03em; border-left: 10px solid #4A0C25; padding-left: 1.5rem; }
        
        h2 { font-size: 1.6rem; font-weight: 700; color: #4A0C25; margin-top: 2.5rem; margin-bottom: 1.25rem; letter-spacing: -0.01em; }
        p { margin-bottom: 1.5rem; line-height: 1.9; color: #475569; text-align: justify; font-size: 1.05rem; }
        ...
        th { background-color: #0f172a; color: #ffffff; font-weight: 700; text-align: left; padding: 1.2rem 1rem; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.1em; }
        td { padding: 1.1rem 1rem; border-bottom: 1px solid #f1f5f9; color: #334155; font-size: 0.95rem; vertical-align: top; line-height: 1.6; }
        tr:hover td { background-color: #fafbfc; }

        /* Strategic Teaser Components */
        ...
        .insight-highlight { background: linear-gradient(135deg, #fdfcfd 0%, #fff 100%); border-left: 6px solid #C49A23; padding: 2rem; margin: 2.5rem 0; font-style: italic; color: #4A0C25; font-weight: 600; border-radius: 4px; box-shadow: 0 10px 30px rgba(0,0,0,0.04); font-size: 1.15rem; line-height: 1.6; }
...
<body class="flex h-screen overflow-hidden">
    ...
    <aside class="w-80 sidebar text-slate-300 flex flex-col h-full overflow-y-auto shrink-0 shadow-2xl z-20">
        ...
        <div class="p-6 border-t border-white/10 text-[10px] text-slate-500 uppercase tracking-widest bg-black/20 text-center">
            &copy; 2026 SMR Group • CONFIDENTIAL ADVISORY
        </div>
    </aside>
    ...
    <main class="flex-1 overflow-y-auto bg-[#FBFBFC] relative p-8 md:p-12 lg:p-24 scroll-smooth" id="main-content">
        ...
        <article id="ch1" class="chapter-content active max-w-5xl mx-auto">
            <div class="header-block">
                <span class="header-kicker">Strategic Objective 01</span>
            ...
            <table>
                <thead><tr><th>Segment</th><th>2025 ($Mn)</th><th>2030 ($Mn)</th><th>2035 ($Mn)</th><th>CAGR (%)</th></tr></thead>
                <tbody>
                    <tr><td>RF / High-Frequency</td><td>$839.12 (58.0%)</td><td>$973.82</td><td>$1,143.43 (54.1%)</td><td>3.14%</td></tr>
                    <tr><td>Compact Ferrite / NFC</td><td>$474.81 (32.8%)</td><td>$559.94</td><td>$672.22 (31.8%)</td><td>3.54%</td></tr>
                    <tr><td class="font-bold text-[#C49A23]">Automotive-Qualified</td><td>$132.75 (9.2%)</td><td>$193.77</td><td>$299.60 (14.2%)</td><td class="font-bold text-emerald-600">8.48%</td></tr>
                    <tr class="bg-slate-50 font-bold"><td>Total Global Market</td><td>$1,446.68</td><td>$1,727.54</td><td>$2,115.25</td><td>3.87%</td></tr>
                </tbody>
            </table>
            <div class="insight-highlight">Strategic Mandate: Raw unit volumes no longer correlate linearly with revenue. Manufacturers that successfully pivot their portfolios toward stringent qualification standards secure disproportionate shares of the profit pool.</div>
        </article>

        <article id="ch2" class="chapter-content max-w-5xl mx-auto">
            <div class="header-block">
                <span class="header-kicker">Core Market Analysis 02</span>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr><td class="font-bold text-[#C49A23]">Automotive-Qualified</td><td>3.69</td><td>5.24</td><td>7.88</td><td class="font-bold text-emerald-600">7.88%</td></tr>
                    <tr class="bg-slate-50 font-bold"><td>Total Volume Demand</td><td>77.00</td><td>93.60</td><td>116.11</td><td>4.19%</td></tr>
                </tbody>
            </table>
        </article>
        ...
        <article id="ch3" class="chapter-content max-w-5xl mx-auto">
            <div class="header-block">
                <span class="header-kicker">Value Metrics 03</span>
            ...
            <table>
                <thead><tr><th>Segment</th><th>2025 ($/unit)</th><th>2030 ($/unit)</th><th>2035 ($/unit)</th><th>CAGR (%)</th></tr></thead>
                <tbody>
                    <tr><td class="font-bold text-[#C49A23]">Automotive-Qualified</td><td>$0.0360</td><td>$0.0370</td><td>$0.0380</td><td class="text-emerald-600 font-bold">0.54%</td></tr>
                    <tr><td>RF / High-Frequency</td><td>$0.0220</td><td>$0.0215</td><td>$0.0210</td><td class="text-rose-600">-0.46%</td></tr>
                    <tr><td>Compact Ferrite / NFC</td><td>$0.0135</td><td>$0.0130</td><td>$0.0125</td><td class="text-rose-600">-0.76%</td></tr>
                </tbody>
            </table>
            <div class="insight-highlight">Pricing Insight: Automotive-qualified components represent the only category demonstrating positive price appreciation over the decade, establishing an economic moat against high-volume commoditization.</div>
        </article>

        <article id="ch19" class="chapter-content max-w-5xl mx-auto">
            <div class="header-block">
                <span class="header-kicker">Strategic Realignment 19</span>
                <h1 class="header-main-title">Strategy: Opportunity Mapping & Win/Loss Matrix for TDK</h1>
            </div>
            ...
            <table>
                <thead><tr><th>Target Segment</th><th>2035 Rev ($Mn)</th><th>TDK Position</th><th>Strategic Objective</th></tr></thead>
                <tbody>
                    <tr><td>Automotive-Qualified</td><td>$299.60</td><td>High / Advantage</td><td>Capture Premium EV Modules</td></tr>
        ...
        <article id="ch20" class="chapter-content max-w-5xl mx-auto">
            <div class="header-block">
                <span class="header-kicker">Advisory Roadmap 20</span>
            ...
            <div class="teaser-box">🔒 Chapter 20 ROI Metrics: NPV and Payback analysis for factory retooling initiatives are restricted to purchasers.</div>
        </article>
